...
class TestGateway(unittest.IsolatedAsyncioTestCase):
    ...
    async def asyncSetUp(self) -> None:
        ...
        self.admission = AdmissionManager(self.context, self.limiter, self.shedder, self.circuit_breaker)
        ...
        self.rest_adapter = RestAdapter(self.pipeline, self.router, mock_predict, self.ws_adapter)
    ...
    async def test_rest_predict_success(self) -> None:
        ...
        reader, writer = await asyncio.open_connection(self.manager.host, self.manager.port)
