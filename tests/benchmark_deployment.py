...
async def run_benchmarks() -> None:
    ...
    print(
        f"Rolling Update Duration    : {rolling_update_duration_ms:.2f} ms (50 Pods, MaxSurge=2)"
    )
    ...
    print(
        f"HPA Scaling Response Time  : {hpa_scaling_duration_ms:.4f} ms (Scale from 50 to 150 Pods)"
    )
    print("=" * 70)
