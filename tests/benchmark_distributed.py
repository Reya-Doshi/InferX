...
async def run_distributed_benchmark() -> None:
    ...
    for _ in range(50):
        ...
        leaders = [mgr1.election.get_leader(), mgr2.election.get_leader(), mgr3.election.get_leader()]
    ...
    print(f"Average Replication Time : {avg_replication_ms:.3f} ms (Leader -> 2 Followers)")
    print("="*70 + "\n")
