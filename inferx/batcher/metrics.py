...
class BatcherMetrics:
    ...
    def record_batch(self, batch_size: int, actual_tokens: int, padded_tokens: int) -> None:
    ...
    def get_snapshot(self) -> dict:
        ...
        with self._lock:
            efficiency = (self._actual_tokens_total / self._padded_tokens_total) if self._padded_tokens_total > 0 else 1.0
            avg_batch = (self._total_requests_batched / self._batches_flushed) if self._batches_flushed > 0 else 0.0
            return {
